"""
Integration tests for Pattern Extractor API endpoints.
...
Tests the full pattern extraction workflow including:
- POST /api/v1/discovery/upload (upload XML for pattern extraction)
- GET /api/v1/discovery/runs (list pattern extraction runs)
...
class TestPatternExtractorAPI:
    """Test suite for Pattern Extractor API endpoints (backend: Discovery API)."""
